...
package oemware.core.ext.log4j;
...
/**  
 * ANSIColorLayout is a Log4J Layout that formats messages using ANSI colors.<br/><br/>
 *
 ...
 * instead of a PatternLayout.<br/><br/>
 *
 * <b>log4j.properties</b><br/><br/>
 *
 * log4j.appender.A1.layout=org.osuosl.logging.ANSIColorLayout<br/>
 * log4j.appender.A1.layout.ConversionPattern=%-5p [%d{MM-dd-yyyy HH:mm:ss}] %c - %m%n<br/><br/>
 *
 * log4j.appender.A1.all=\u001B[1;37m<br/>
 * log4j.appender.A1.fatal=\u001B[1;31m<br/>
 * log4j.appender.A1.error=\u001B[0;31m<br/>
 * log4j.appender.A1.warn=\u001B[1;33m<br/>
 * log4j.appender.A1.info=\u001B[0;37m<br/>
 * log4j.appender.A1.debug=\u001B[0;36m<br/>
 * log4j.appender.A1.reset=\u001B[1;37m<br/>
 * log4j.appender.A1.stacktrace=\u001B[0;31m<br/>
 * log4j.appender.A1.defaultcolor=\u001B[1;37m<br/><br/>
 *
 * <pre>
 * OCKHAM P2PREGISTRY Copyright 2004 Oregon State University 
 *
 ...
 *         Date: Nov 30, 2005
 *         Time: 1:24:35 PM
 * @version $Id: ANSIColorLayout.java 13 2008-06-15 19:43:04Z oemware $
 */
